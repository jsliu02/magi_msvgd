...
We report several negative results, including that on this problem Stein variational gradient
descent does not merely converge slowly: started \emph{at} a correct answer it moves away from it,
degrading energy distance by a factor of $45$--$80$ while holding marginal standard deviations at
$0.99$ of the reference.
\end{abstract}
