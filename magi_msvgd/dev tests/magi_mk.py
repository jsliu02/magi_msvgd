'''
Experimental copy of magi.py, identical except it inherits from MKSVGD
(msvgd/msvgd_mk.py) -- Multiple Kernel SVGD, combining several RBF bandwidths with
data-dependent weights (Ai, Liu, He & Xu, mksvgd.pdf) -- instead of the standard
single-bandwidth joint-kernel MSVGD. See msvgd_mk.py's module docstring for the method.
'''
...
import optax
from msvgd.msvgd_mk import MKSVGD as MSVGD
